...
function datecheck() {
    if (date == 10) {
        if (page == 'index') {
            ...
            theme.innerHTML = '<div style="display: inline; position: fixed; margin: 0%; width: 20%; top: 5%; left: 0%;"><img src="graphics/themes/halloween/skeleton-wave.gif"></div><div style="display: inline; position: fixed; margin: 0%; width: 20%; top: 55%; left: 0%;"><img src="graphics/themes/halloween/skeleton-creep.gif"></div><div style="display: inline; position: fixed; margin: 0%; width: 20%; top: 20%; right: 0%;"><img src="graphics/themes/halloween/skeleton-hello.gif"></div><div style="position: absolute; margin: 0%; width: 20%; top: 20%; right: 22%;"><img src="graphics/themes/halloween/spookyedition.gif"></div><div style="width: 100vw; height: 100vh; position: fixed; top: 0%; left: 0%; margin: 0px; display: block; pointer-events: none; background-size: cover; background-image: url(graphics/themes/halloween/blood-drip.gif);"></div>';
        }
        else if (page == 'pics') {
